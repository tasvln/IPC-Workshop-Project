...
#define TOTAL_MAX_DAYS 31
#define TOTAL_MIN_DAYS 30
#define TOTAL_MONTHS 12
#define TOTAL_HRS 23
#define TOTAL_MINS 59
...
void addAppointment(struct Appointment *appoint, int maxApt, struct Patient *patient, int maxPat);

// Remove an appointment record from the appointment array
void removeAppointment(struct Appointment *appoint, int maxApt, struct Patient *patient, int maxPat);
